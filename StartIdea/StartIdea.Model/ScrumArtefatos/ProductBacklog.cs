...
namespace StartIdea.Model.ScrumArtefatos
{
    ...
    public class ProductBacklog
    {
        ...
        [DisplayName("User Story"), Required(ErrorMessage = "Campo User Story obrigatório."),
         StringLength(150, ErrorMessage = "Campo User Story deve ter no máximo 150 caracteres."), DataType(DataType.MultilineText)]
        public string UserStory { get; set; }

        [DisplayName("Story Point")]
        public StoryPoint StoryPoint { get; set; }

        [Required(ErrorMessage = "Campo Prioridade obrigatório."), Range(1, 9999, ErrorMessage = "Campo Prioridade deve ser maior do que zero.")]
